...
public class CustomAdapterSpinnerTech extends ArrayAdapter<Technicien> {
    List<Technicien> values;
    private Context context;


    public CustomAdapterSpinnerTech(Context context, int textViewResourceId
            , List<Technicien> values) {
    ...
    @Override
    public Technicien getItem(int i) {
        return values.get(i);
    }
