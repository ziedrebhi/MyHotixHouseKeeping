...
public class CustomAdapterSpinnerTypePanne extends ArrayAdapter<TypesPanne> {
    List<TypesPanne> values;
    private Context context;


    public CustomAdapterSpinnerTypePanne(Context context, int textViewResourceId
            , List<TypesPanne> values) {
    ...
    @Override
    public TypesPanne getItem(int i) {
        return values.get(i);
    }
